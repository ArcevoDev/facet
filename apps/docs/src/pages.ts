    ...
    blocks: [
      ...
      { type: "h2", text: "Packages" },
      {
        ...
        items: [
          ...
          "`@arcevo/facet-components`: 113 styled UI components (Radix + tailwind-merge + variants), including ready-to-use extras (Dropzone, ColorPicker, QRCode, Marquee, Roadmap, Form, Stepper, KanbanBoard, ChangelogList).",
