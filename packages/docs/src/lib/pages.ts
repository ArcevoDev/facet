 ...
 * Foundations / Ecosystem sections from this same registry, so pages and
 * navigation stay in lockstep: add a page here and it renders via
 * DocsContentPage and appears in the sidebar and search palette with zero
 * component edits.
 *
 * Consumers can drop their own pages into this registry (e.g. arc-id's
 * "Overview", "Getting Started", "API Reference") without forking or new files.
 */
...
/** The docs pages registry: facet's own pages, easily extended by consumers. */
...
export function App() {
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "The registry ships with a lucide-based default map: settings, logout, chevronDown, search, check, copy, moon, sun, bell, menu, close, chevronLeft, chevronRight, chevronUpDown, arrowRight, sparkles, github, bookOpen, building, compass, layers, palette, keyRound, users, shield, creditCard, dashboard, document, help, grid, list, triangleAlert, user.",
      },
