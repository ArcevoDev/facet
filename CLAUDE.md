...
packages/components/   ← 85 styled Radix components (shadcn-style, Radix + tailwind-merge)
...
3. ✅ `packages/components/`: 85 styled Radix components + theme system + IconRegistry (+15 this session: card animations, ready-to-use auth/security/settings/marketing/dashboard surfaces; notification-bell removed)
