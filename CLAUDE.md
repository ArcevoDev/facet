...
packages/components/   ← 60 styled Radix components (shadcn-style, Radix + tailwind-merge)
...
3. ✅ `packages/components/`: 60 styled Radix components + theme system + IconRegistry (+11 this session: color-picker, country-code-input, data-table, date-picker, dropzone, form, location-picker, marquee, number-input, qrcode, roadmap; notification-bell removed)
